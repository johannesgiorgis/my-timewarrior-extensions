...
This provides an interface for TimeWarrior report data.

It was copied from [Time-Report PyPI package](https://github.com/lauft/timew-report).

Below is its README contents provided here for easy reference:

---

## timew-report original
